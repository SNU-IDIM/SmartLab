...
DEMO_COLOR_SENSOR_HANDLE  =  10020

TASK_ADHESIVE_SAVER_IN    =  10031
TASK_ADHESIVE_SAVER_OUT   = -10031
TASK_ADHESIVE_DROP        =  10032
TASK_SPECIMEN_TO_LEFT     =  10033
TASK_SPECIMEN_TO_RIGHT    =  10034
...
Q_SEARCH_3DP_RIGHT     = [-91.81610870361328, 45.50328826904297, -126.2701187133789, -1.1883552074432373, -65.01715087890625, -178.0843963623047]
...
P_COLOR_SENSOR_TRAY = [-292.6132507324219, 113.29225158691406, 188.91656494140625, 180, -180, 90]
OFFSET_COLOR_SENSOR = 12.5
P_COLOR_SENSOR_1 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_1[0] -=  4 * OFFSET_COLOR_SENSOR 
P_COLOR_SENSOR_2 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_2[0] -=  3 * OFFSET_COLOR_SENSOR 
P_COLOR_SENSOR_3 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_3[0] -=  2 * OFFSET_COLOR_SENSOR 
P_COLOR_SENSOR_4 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_4[0] -=  1 * OFFSET_COLOR_SENSOR 
P_COLOR_SENSOR_5 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_5[0] -= -1 * OFFSET_COLOR_SENSOR
P_COLOR_SENSOR_6 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_6[0] -= -2 * OFFSET_COLOR_SENSOR
P_COLOR_SENSOR_7 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_7[0] -= -3 * OFFSET_COLOR_SENSOR
P_COLOR_SENSOR_8 = deepcopy(P_COLOR_SENSOR_TRAY);   P_COLOR_SENSOR_8[0] -= -4 * OFFSET_COLOR_SENSOR

# RACK PICK AND PLACE POSITION
P_PLACE_INITIAL = [-295, -100.0, 322.0, -180.0, -180.0, 0.0]
P_PLACE_INCLINE = [-295, -100.0, 200.0, 90.0, 135.0, 0.0]
P_PLACE_RACK_1  = [-272.0, 168.5, 166.0, 90.0, -135.0, 0.0]
P_PLACE_RACK_2  = deepcopy(P_PLACE_RACK_1);                      P_PLACE_RACK_2[1] -= 14.5; 
P_PLACE_RACK_3  = deepcopy(P_PLACE_RACK_1);                      P_PLACE_RACK_3[1] -= 14.5 * 2.0; 
P_PLACE_RACK_4  = deepcopy(P_PLACE_RACK_1);                      P_PLACE_RACK_4[1] -= 14.5 * 3.0; 
P_PICK_INITIAL  = [-357.0, 165.0, 322.0, -180.0, -180.0, 0.0]
P_PICK_INCLINE  = [-357.0, 165.0, 322.0, 90.0, -135.0, 0.0]
P_PICK_RACK_1   = [-295.0, -77.0, 181.0, 90.0, 135.0, 0.0]
P_PICK_RACK_2   = deepcopy(P_PICK_RACK_1);                       P_PICK_RACK_2[1] -= 14.5; 
P_PICK_RACK_3   = deepcopy(P_PICK_RACK_1);                       P_PICK_RACK_3[1] -= 14.5 * 2.0; 
P_PICK_RACK_4   = deepcopy(P_PICK_RACK_1);                       P_PICK_RACK_4[1] -= 14.5 * 3.0; 
