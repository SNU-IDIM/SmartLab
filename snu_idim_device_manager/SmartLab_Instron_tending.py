...
class SmartLABCore():
    def __init__(self, ip_='192.168.60.21', port_=5555):
        ...
        self.req = dict()
        self.req['test_mode'] = 'debug'
        self.req['test_step'] = -1
        self.req['setup_device'] = ['R_001/amr', 'R_001/cobot', 'instron']
        self.req['setup_doe'] = {
                                'header_id': 'DRY_TEST',
    ...
    def executionManager(self):
        ...
        self.tending_mode = True
        subject_id = 'specimen1'
        while True:
                ## Check the execution mode (auto: 0 / step: 1 / debug: -1)


            if self.tending_mode == True:
            ...
            if self.test_step == 0: ## Step 0. 시편 제작 완료 시 시작
                ...
                self.mysql.update(tablename='result', attrs_dict={'subject_name': subject_id}, cond_dict=measurement_data)
